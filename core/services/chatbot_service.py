...
SYSTEM_INSTRUCTION = (
    ...
    # "Nếu là gợi ý uống thuốc, nhưng trong hồ sơ chưa có thì hãy flex thời gian thường là sau khi ăn xong hoặc với 1 số bệnh đặc biệt là trước ăn (cho 1 thời gian cụ thể nếu người dùng hỏi, thường là 7 hoặc 8h hoặc sau ăn, etc,...)"
